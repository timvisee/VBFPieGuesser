...
-- Dumping data for table vbfpieguesser.vpg_registry: ~0 rows (approximately)
/*!40000 ALTER TABLE `vpg_registry` DISABLE KEYS */;
INSERT INTO `vpg_registry` (`registry_id`, `registry_key`, `registry_value`, `registry_modified_datetime`) VALUES
...
/*!40000 ALTER TABLE `vpg_registry` ENABLE KEYS */;
